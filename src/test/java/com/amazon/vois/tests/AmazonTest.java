...
public class AmazonTest extends BaseTest{
    ...
    @Test
    public void verifyThatUserCanAddProductFromTodayLivesAmazonOffers() throws TesseractException, IOException, InterruptedException {
    ...
    @Test
    public void verifyThatUserSearchItemAndChooseQuantityThenAddedToCartCorrectly() throws TesseractException, IOException, InterruptedException {
        String inputSearch = "car accessories";
        int firstSearchResult = 1;
        ...
        double expectedTotalAmount = firstPrice * quantityNumber;
